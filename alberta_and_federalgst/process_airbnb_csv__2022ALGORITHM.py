...
# OK now let's deal with JAN of 2022
exchrate_endperiod = 1.273
exchrate = exchrate_endperiod


# OK now let's deal with FEB of 2022
exchrate_endperiod = 1.273   # no net change from JAN!
exchrate = exchrate_endperiod

# OK now let's deal with MAR of 2022
exchrate_endperiod = 1.257
exchrate = exchrate_endperiod

# OK now let's deal with APR of 2022
exchrate_endperiod = 1.299
exchrate = exchrate_endperiod

# OK now let's deal with MAY of 2022
exchrate_endperiod = 1.276
exchrate = exchrate_endperiod

# OK now let's deal with JUN of 2022
exchrate_endperiod = 1.302
exchrate = exchrate_endperiod

# OK now let's deal with JUL of 2022
exchrate_endperiod = 1.294
exchrate = exchrate_endperiod

# OK now let's deal with AUG of 2022
exchrate_endperiod = 1.313
exchrate = exchrate_endperiod
            ...
            if row['Amount']:
                ...
                if 'Resolut' in row['Type']:
                    ...
                    if '(cancel' in row['Guest']:
                        ...
                        if (not do_assume_taxrate_09percent) and ('SYNTH' in row['CollectedTaxRate']):
